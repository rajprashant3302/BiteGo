      ...
      <div className="absolute top-0 left-0 right-0 z-20 p-4 sm:p-6">
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between gap-4">
            <div className="pointer-events-auto rounded-[24px] border border-white/10 bg-black/60 px-5 py-3 backdrop-blur-md">
              <span className="block font-black text-white text-lg">BiteGo</span>
            ...
            <button
              ...
              className={`pointer-events-auto rounded-full px-5 py-3 text-xs font-black uppercase tracking-widest text-white shadow-lg transition-all ${isOnline ? "bg-red-500" : "bg-green-500"
                }`}
            >
          ...
          <div className="pointer-events-auto flex gap-2 overflow-x-auto">
            <Link
              ...
              className="whitespace-nowrap rounded-full border border-white/10 bg-black/50 px-4 py-2 text-sm font-semibold text-white backdrop-blur-md hover:bg-orange-500/80"
            >
              Profile
            </Link>
            <Link
