...
export default function LoginForm({ navigateTo = (view) => console.log(`Navigating to ${view}`) }: NavProps) {
          ...
          <div className="auth-form-container">
            <div className="auth-form-box active">
              ...
              <form onSubmit={handleLogin}>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '-10px', marginBottom: '20px' }}>
                  ...
                  <span 
                    ...
                    style={{ color: '#888', fontSize: '0.8rem', textDecoration: 'none', cursor: 'pointer' }}
                  >
                    Forgot Password?
                  </span>
                </div>
              ...
              <div className="footer-link">
                {/* LINK TO SIGNUP */}
                Not a member? <span onClick={() => navigateTo('signup')} style={{color: '#fff', textDecoration: 'underline', cursor: 'pointer'}}>Sign Up Now</span>
              </div>
            </div>
          </div>
        </div>
