...
export default function EditProfilePage() {
  ...
  const isPageLoading = status === "loading" || status === "unauthenticated";
  
  
  const displayProfilePic = imagePreview || session?.user?.image || `https://api.dicebear.com/7.x/avataaars/svg?seed=${session?.user?.name || 'User'}`;
