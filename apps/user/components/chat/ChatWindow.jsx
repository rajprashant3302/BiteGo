...
// import { Smile, Image as ImageIcon, Film, Send, X, Loader2, Check, CheckCheck, Clock3 } from 'lucide-react';
...
//                 <div className="text-sm font-semibold text-slate-700">Customer Support</div>
...
//                     Previous token expired. Old messages are still visible. A new token will be created automatically when you send a new message.
//                 </div>
//             )}
...
//                             <div className={`max-w-[75%] p-3 rounded-2xl shadow-sm flex flex-col relative ${isMine
...
//                                 {msg.text && <p className="text-sm whitespace-pre-wrap pr-10">{msg.text}</p>}

//                                 <div className={`absolute bottom-2 right-2 flex items-center gap-1 text-[10px] ${isMine ? 'text-white/80' : 'text-slate-400'}`}>
...
//                     <textarea
//                         className="flex-1 bg-slate-100 p-3 rounded-2xl outline-none resize-none max-h-32 text-sm text-slate-900 placeholder:text-slate-400 disabled:opacity-70"
//                         rows={1}
//                         value={message}
