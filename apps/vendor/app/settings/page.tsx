...
import { 
  ...
  FiBriefcase, FiFileText, FiPieChart 
} from "react-icons/fi";
...
export default function ProfileSettingsPage() {
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        { name: "My Restaurants", icon: <FiBriefcase />, link: "/partner/restaurants", desc: "Manage your storefronts and menus" },
        { name: "Business Details", icon: <FiFileText />, link: "/partner/business-details", desc: "Update your PAN and Bank information" },
        { name: "Partner Analytics", icon: <FiPieChart />, link: "/partner/analytics", desc: "View your earnings and order history" },
      ]
    },
    {
