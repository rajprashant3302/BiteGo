                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col p-4 bg-slate-50 rounded-2xl border border-slate-200">
                            ...
                            <div className="flex bg-white p-1 rounded-xl border border-slate-200 shadow-sm">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center py-2 rounded-lg text-sm font-bold transition-all ${formData.isVeg ? "bg-green-600 text-white shadow-md" : "text-slate-500 hover:bg-slate-50"
                                        }`}
                                >
                                    Pure Veg
                                </button>
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center py-2 rounded-lg text-sm font-bold transition-all ${!formData.isVeg ? "bg-red-600 text-white shadow-md" : "text-slate-500 hover:bg-slate-50"
                                        }`}
                                >
                                    Non-Veg
                                </button>
                        ...
                        <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-200">
                            ...
                            <button
                                ...
                                className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors outline-none ring-offset-2 focus:ring-2 ring-orange-500 ${formData.isAvailable ? "bg-orange-500" : "bg-slate-400"
                                    }`}
                            >
                                <span
                                    className={`inline-block h-5 w-5 transform rounded-full bg-white transition-transform ${formData.isAvailable ? "translate-x-6" : "translate-x-1"
                                        }`}
                                />
                            </button>
                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        placeholder="299"
                                        className="w-full p-4 bg-white border-2 border-slate-100 rounded-2xl outline-none focus:border-orange-500 transition-all text-slate-800 font-semibold"
                                    />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-slate-500 uppercase ml-1">Stock Qty</label>
                                    <input
                                        required
                                        type="number"
