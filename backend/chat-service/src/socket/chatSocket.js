...
// const getMergedMessagesForUser = async (userId) => {
...
// const markMessagesDeliveredForUserThread = async (userId, receiverId) => {
//     const conversations = await ConversationModel.find({
//         $or: [
//             { sender: userId, receiver: SUPPORT_INBOX_ID },
//             { sender: SUPPORT_INBOX_ID, receiver: userId }
...
//     for (const conv of conversations) {
//         for (const msg of conv.messages || []) {
//             if (msg.msgByUserId !== receiverId && msg.status === 'sent') {
//                 idsToMark.push(msg._id);
//             }
//         }
//     }
...
//     const messages = await getMergedMessagesForUser(userId);
//     const meta = await getSupportMetaForUser(userId);

//     io.to(getThreadRoom(userId)).emit('message', messages);
...
//                 let conversation = await getOrCreateActiveSupportConversation(
//                     actualUserId,
